...
class OAuth2Controller(
    ...
    fun token(
        ...
        val subject = "service:${client.clientId}"
        val accessToken = jwtUtil.generateAccessToken(subject, roles, scopes)
        val (tokenId, refreshToken) = jwtUtil.generateRefreshToken(subject, roles, scopes)
        refreshTokenService.store(tokenId, subject)
